...
public:
	...
	unique_ptr<LinkedBag<ItemType>> getSortedLB(unique_ptr<Node<ItemType>>&, unique_ptr<Node<ItemType>>&);
private:
...
private:
	unique_ptr<Node<ItemType>> headPtr{ nullptr }; // Pointer to first node
